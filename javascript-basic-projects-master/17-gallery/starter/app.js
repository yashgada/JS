...
function Gallery(element) {
  ...
  // self reference is an alternative to duck the "this" confusion and games. Switch comments on  and take a look.
  let self = this;
  // bind functions
...
Gallery.prototype.openModal = function (selectedImage, list) {
  // for the code here to work, the "this" needs to point to an instance of Gallery.
  // console.log(this);
